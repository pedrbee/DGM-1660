...
//Name: Robot model 02.ma
//Last modified: Tue, Feb 06, 2018 04:58:37 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -8.1678565811254824 6.642162805055924 18.646835131665497 ;
	setAttr ".r" -type "double3" -5.7383527302265191 325.4000000003727 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "3B7119E4-4573-F0E2-EF61-FCBAE73956F3";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 14.3374575629483;
...
createNode transform -n "pCube13";
	...
	setAttr ".t" -type "double3" 1.5028548188645792 3.404984353183548 -0.025000895623210506 ;
	setAttr ".s" -type "double3" 1.0297860085135602 1.0297860085135602 1.0297860085135602 ;
...
createNode transform -n "pCube14";
	...
	setAttr ".t" -type "double3" 1.5028548188645789 2.6027526204038853 -0.025000895623210506 ;
	setAttr ".s" -type "double3" 1.7549930167705312 1.7549930167705312 1.7549930167705312 ;
createNode mesh -n "pCubeShape14" -p "|pCube14";
	...
	setAttr ".hfd" -type "dataPolyComponent" Index_Data Face 0 ;
	setAttr ".ai_translator" -type "string" "polymesh";
createNode transform -n "pCube26" -p "|pCube14";
	rename -uid "E1A7E2FE-43BB-B4A3-4667-D99A9634A99C";
	setAttr ".t" -type "double3" 0.017947837105180886 0.98477194056527706 0.014245581255483425 ;
	setAttr ".s" -type "double3" 0.72738326184360325 0.72738326184360347 0.72738326184360325 ;
createNode mesh -n "pCubeShape26" -p "|pCube14|pCube26";
...
createNode transform -n "pCube9";
	...
	setAttr ".t" -type "double3" 1.5028548188645789 3.794851192134757 -0.025000895623210499 ;
	setAttr ".s" -type "double3" 0.55762875374190624 0.55762875374190624 0.55762875374190624 ;
...
createNode transform -n "pCube43";
	...
	setAttr ".t" -type "double3" 0 4.1913412136662673 7.6707303722316915 ;
createNode mesh -n "pCubeShape43" -p "pCube43";
	rename -uid "157F2D93-4E64-DD59-95E0-C88D821467CB";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.49999998509883881 0.0625 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 86 ".pt";
	setAttr ".pt[0]" -type "float3" 0.35876238 0.22339211 0 ;
	setAttr ".pt[1]" -type "float3" -0.35876238 0.22339211 0 ;
	setAttr ".pt[2]" -type "float3" 0 0.085239477 0 ;
	setAttr ".pt[3]" -type "float3" 0 0.085239477 0 ;
	setAttr ".pt[6]" -type "float3" 0.28152004 0.19957361 0 ;
	setAttr ".pt[7]" -type "float3" -0.28152004 0.19957361 0 ;
	setAttr ".pt[8]" -type "float3" 0 -0.17784338 0.20250514 ;
	setAttr ".pt[9]" -type "float3" 0 -0.09147568 0 ;
	setAttr ".pt[10]" -type "float3" 0 0.19087304 0 ;
	setAttr ".pt[12]" -type "float3" 0 0.19087304 0 ;
	setAttr ".pt[13]" -type "float3" 0 0.32682323 0 ;
	setAttr ".pt[14]" -type "float3" 0 0.18022919 0 ;
	setAttr ".pt[16]" -type "float3" 0 0.18022919 0 ;
	setAttr ".pt[17]" -type "float3" 0 0.26010942 0 ;
	setAttr ".pt[18]" -type "float3" -1.4901161e-008 0 0 ;
	setAttr ".pt[20]" -type "float3" 1.4901161e-008 0 0 ;
	setAttr ".pt[21]" -type "float3" 0 0.46821219 0 ;
	setAttr ".pt[22]" -type "float3" -0.23081912 0.61437601 0 ;
	setAttr ".pt[23]" -type "float3" 0.23081912 0.61437601 0 ;
	setAttr ".pt[24]" -type "float3" 0 0.35083055 0 ;
	setAttr ".pt[25]" -type "float3" 0 0.35083055 0 ;
	setAttr ".pt[26]" -type "float3" 0 -0.027313247 0.093623228 ;
	setAttr ".pt[27]" -type "float3" 0.18115838 0.28369975 0 ;
	setAttr ".pt[29]" -type "float3" 0 -0.15259111 0.10068564 ;
	setAttr ".pt[30]" -type "float3" 0 0.020708214 0.14065552 ;
	setAttr ".pt[31]" -type "float3" 0 0.13113104 0 ;
	setAttr ".pt[32]" -type "float3" 0 0.11222211 0 ;
	setAttr ".pt[34]" -type "float3" 0 0.18737452 0 ;
	setAttr ".pt[35]" -type "float3" 0 0.24027492 0 ;
	setAttr ".pt[36]" -type "float3" 0 0.15279098 0 ;
	setAttr ".pt[37]" -type "float3" 0 -0.12279339 0 ;
	setAttr ".pt[39]" -type "float3" 0 0.18918404 -0.011565795 ;
	setAttr ".pt[40]" -type "float3" 0 0.19663566 0 ;
	setAttr ".pt[41]" -type "float3" 0 0.36188042 0 ;
	setAttr ".pt[42]" -type "float3" 0.29617521 0.59819859 0 ;
	setAttr ".pt[44]" -type "float3" 0 0.33342409 0 ;
	setAttr ".pt[45]" -type "float3" 0 0.41188917 0 ;
	setAttr ".pt[46]" -type "float3" -0.079500705 0.39311033 0 ;
	setAttr ".pt[47]" -type "float3" -0.18115838 0.28369975 0 ;
	setAttr ".pt[48]" -type "float3" -0.21483196 0.54960161 0 ;
	setAttr ".pt[49]" -type "float3" -0.077502981 0.45043653 0 ;
	setAttr ".pt[50]" -type "float3" 0 0.35341817 0 ;
	setAttr ".pt[51]" -type "float3" 0.21463324 0.3613753 0 ;
	setAttr ".pt[52]" -type "float3" 0.096827812 0.20598815 -2.9802322e-008 ;
	setAttr ".pt[53]" -type "float3" 0.077502981 0.45043653 0 ;
	setAttr ".pt[54]" -type "float3" 0 0.23103192 0 ;
	setAttr ".pt[55]" -type "float3" 0 -0.027313247 0.093623228 ;
	setAttr ".pt[57]" -type "float3" 0 0.020708214 0.14065552 ;
	setAttr ".pt[58]" -type "float3" 0.024756398 -0.096778564 0.10914525 ;
	setAttr ".pt[59]" -type "float3" 0 0.21352266 0 ;
	setAttr ".pt[61]" -type "float3" 0 -0.29847521 0.23712772 ;
	setAttr ".pt[62]" -type "float3" -0.024756398 -0.096778564 0.10914525 ;
	setAttr ".pt[63]" -type "float3" 0 0.21352266 0 ;
	setAttr ".pt[64]" -type "float3" 0 0.13113104 0 ;
	setAttr ".pt[65]" -type "float3" 0 0.11222211 0 ;
	setAttr ".pt[66]" -type "float3" 0 0.24027492 0 ;
	setAttr ".pt[67]" -type "float3" 0 0.15837483 0 ;
	setAttr ".pt[68]" -type "float3" 0 0.11878853 0 ;
	setAttr ".pt[70]" -type "float3" 0 0.20784721 0 ;
	setAttr ".pt[71]" -type "float3" 0 0.15837483 0 ;
	setAttr ".pt[72]" -type "float3" 0 0.11878853 0 ;
	setAttr ".pt[73]" -type "float3" 0 0.15279098 0 ;
	setAttr ".pt[74]" -type "float3" 0 -0.12279339 0 ;
	setAttr ".pt[75]" -type "float3" 0 0.19663566 0 ;
	setAttr ".pt[76]" -type "float3" 0 0.26230115 0 ;
	setAttr ".pt[77]" -type "float3" -0.096827812 0.20598815 -2.9802322e-008 ;
	setAttr ".pt[79]" -type "float3" 0 0.40646297 0 ;
	setAttr ".pt[80]" -type "float3" 0 0.26230115 0 ;
	setAttr ".pt[81]" -type "float3" 0 0.36188042 0 ;
	setAttr ".pt[82]" -type "float3" -0.29617521 0.59819859 0 ;
	setAttr ".pt[83]" -type "float3" 0 0.41188917 0 ;
	setAttr ".pt[84]" -type "float3" 0 0.29741842 0 ;
	setAttr ".pt[85]" -type "float3" 0 0.44664222 0 ;
	setAttr ".pt[86]" -type "float3" 0 0.29741842 0 ;
	setAttr ".pt[87]" -type "float3" 0.21483196 0.54960161 0 ;
	setAttr ".pt[88]" -type "float3" -0.21463324 0.3613753 0 ;
	setAttr ".pt[89]" -type "float3" 0 0.23103192 0 ;
	setAttr ".pt[90]" -type "float3" 0 0.099219948 0 ;
	setAttr ".pt[91]" -type "float3" 0 0.16836847 0 ;
	setAttr ".pt[92]" -type "float3" 0 0.16203824 0 ;
	setAttr ".pt[93]" -type "float3" 0.079500705 0.39311033 0 ;
	setAttr ".pt[94]" -type "float3" 0 0.35341817 0 ;
	setAttr ".pt[95]" -type "float3" 0 0.16203824 0 ;
	setAttr ".pt[96]" -type "float3" 0 0.16836847 0 ;
	setAttr ".pt[97]" -type "float3" 0 0.099219948 0 ;
	setAttr ".ai_translator" -type "string" "polymesh";
...
connectAttr "polySubdFace1.out" "pCubeShape43.i";
...
connectAttr "|pCube13|pCubeShape13.iog" ":initialShadingGroup.dsm" -na;
connectAttr "|pCube9|pCubeShape9.iog" ":initialShadingGroup.dsm" -na;
connectAttr "|pCube14|pCube26|pCubeShape26.iog" ":initialShadingGroup.dsm" -na;
connectAttr "pCubeShape42.iog" ":initialShadingGroup.dsm" -na;
connectAttr "pCubeShape43.iog" ":initialShadingGroup.dsm" -na;
// End of Robot model 02.ma
